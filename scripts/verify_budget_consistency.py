...
RUBY_MAT_RANGE = (4839, 4900)    # positive_int + output_budget
# 5th copy: the ruby block inside ai_litellm_context_harness_reservations_ok().
# positive_int (5702-5707) ... output_budget (5733-5767). The intervening
# selections() def (5709-5731) is inert here -- never called -- and harmless.
RUBY_RES_RANGE = (5702, 5767)    # positive_int + (selections) + output_budget
